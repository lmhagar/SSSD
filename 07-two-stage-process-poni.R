...
sssdGamma <- function(conviction, power, equivalence, gamma_alpha.1, gamma_beta.1, gamma_alpha.2, gamma_beta.2,  
  ...
  getNormal <- function(u, targetP, params, delta_star, n_val, hyper){
    ...
    ## create two points at which to minimize difference between log-posterior and normal approximation
    ...
    ## now we need to find the correlation (compute log-posterior at 4 points on axes around posterior mode)
